...
public class DelegationPanel extends VLayout implements RefreshObserver{	
	...
	public DelegationPanel() {            	
		...
		addMember(new TrackPanel(I18N.message("dashboard")+" > "+ I18N.message("delegation"), this));
	...
	private DelegationGridPanel createDelegationVL(boolean isRefresh) {		
		return isRefresh ? 
				new DelegationGridPanel("dashboard.dashboard.delegation", I18N.message("delegation"), null, true) :
					DelegationGridPanel.get("dashboard.dashboard.delegation", I18N.message("delegation"), null, true);
	}
